...
function scrollUp(){
    ...
    // When the scroll is higher than 350 viewport height, add the show-scroll class to the a tag with scroll-up
...
// Active / deactivate the the manually with the button
